...
const SearchComponents = ({wallet, setWallet}) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <button onClick={connectWallet} className="px-3 py-3 bg-blue-400 text-black font-bold rounded transform hover:scale-105">
